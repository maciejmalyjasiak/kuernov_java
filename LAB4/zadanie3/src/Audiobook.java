public class Audiobook extends Produkt {
    ...
    public Audiobook(int id, String data_wydania, String autor, String wydawnictwo, String tytul, double cena, double rozmiar_w_mb, double dlugosc_w_min,Klient wPosiadaniu) {
        super(id, data_wydania, autor, wydawnictwo, tytul, cena, wPosiadaniu);
